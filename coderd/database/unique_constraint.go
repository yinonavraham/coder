...
const (
	...
	UniqueRelationshipsIDKey                                UniqueConstraint = "relationships_id_key"                                     // ALTER TABLE ONLY relationships ADD CONSTRAINT relationships_id_key UNIQUE (id);
	UniqueRelationshipsParentChildKey                       UniqueConstraint = "relationships_parent_child_key"                           // ALTER TABLE ONLY relationships ADD CONSTRAINT relationships_parent_child_key UNIQUE (parent, child);
