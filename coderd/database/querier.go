...
type sqlcQuerier interface {
	...
	GetRelationships(ctx context.Context, arg GetRelationshipsParams) ([]Relationship, error)
	...
	InsertRelationships(ctx context.Context, arg InsertRelationshipsParams) ([]Relationship, error)
