...
var (
	...
	TerraformVersion = version.Must(version.NewVersion("1.1.9"))

	minTerraformVersion = version.Must(version.NewVersion("1.1.9"))
	maxTerraformVersion = version.Must(version.NewVersion("1.1.9"))
